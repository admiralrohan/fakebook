...
$(document).ready(function() {
  ...
  $(".like-count").on("click", likeCountActions);
      ...
      if (res.success) {
        $.ajax({
          ...
          success: function(res) {
            $.ajax({
              type: "POST",
              url: "ajax/update_like_count.php",
              data: { users: res.users },
              dataType: "json",
              success: function(res) {
                if (res.success) {
                  $(`#post-${id} .like-count`).replaceWith(res.content);
                  $(`#post-${id} .like-count`).on("click", likeCountActions);
                  $('[data-toggle="tooltip"]').tooltip();
                }
              }
            });
        ...
        $.ajax({
          ...
          success: function(res) {
            $.ajax({
              type: "POST",
              url: "ajax/update_like_button.php",
...
function likeCountActions(event) {
  event.preventDefault();
      ...
      if (res.success) {
        const alertHTMLString = `
          <div class="alert alert-primary fade show" role="alert">
            <span>
              Your post has been shared. View <a href="${
                res.newPostUrl
              }" class="alert-link">your new post</a>.
            </span>
